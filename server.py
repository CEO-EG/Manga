...
:root{
  ...
  --line:#2b2b31;--line-soft:#202025;--text:#f4f4f5;--muted:#a1a1aa;--dim:#71717a;--overlay:#1a1e26;--overlay-soft:rgba(255,255,255,.045);--soft-green:rgba(34,197,94,.105);--soft-blue:rgba(59,130,246,.105);--soft-purple:rgba(168,85,247,.11);
...
.nav{display:flex;flex-direction:column;gap:4px}.nav-label{padding:10px 10px 6px;color:var(--dim);font:800 10px/1 var(--mono);letter-spacing:.14em;text-transform:uppercase}.nav-item{position:relative;width:100%;display:flex;align-items:center;gap:11px;padding:11px 12px 11px 14px;border:1px solid transparent;border-radius:11px;background:transparent;color:var(--muted);font-size:14px;font-weight:700;text-align:left;cursor:pointer;transition:.16s ease}.nav-item::before{content:"";position:absolute;left:0;top:9px;bottom:9px;width:2px;background:transparent}.nav-item:hover{background:rgba(26,30,38,.68);color:var(--text);border-color:rgba(255,255,255,.04)}.nav-item.active{background:linear-gradient(90deg,rgba(59,130,246,.12),rgba(168,85,247,.07) 45%,rgba(26,30,38,.55));color:var(--text);border-color:rgba(255,255,255,.055);box-shadow:0 0 22px rgba(59,130,246,.035)}.nav-item.active::before{background:#dbeafe}.nav-icon,.bn-ico{display:inline-grid;place-items:center;flex:0 0 auto}.nav-icon svg{width:19px;height:19px;stroke:currentColor;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.nav-badge{margin-left:auto;display:none;min-width:20px;height:20px;border-radius:999px;background:#3f3f46;color:#fff;font:800 10px/20px var(--mono);text-align:center}
...
.btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;border:1px solid transparent;border-radius:10px;padding:10px 15px;cursor:pointer;font-size:13px;font-weight:800;text-decoration:none;white-space:nowrap;transition:.14s ease}.btn svg,.m-overlay-btn svg,.reader-close svg,.rnav-btn svg{width:17px;height:17px;stroke:currentColor;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.btn:hover{transform:translateY(-1px)}.btn:disabled{opacity:.44;cursor:not-allowed;transform:none!important}.btn-red{background:var(--soft-blue);color:#dbeafe;border-color:rgba(59,130,246,.18);box-shadow:inset 0 1px 0 rgba(255,255,255,.045)}.btn-red:hover{background:rgba(59,130,246,.15);border-color:rgba(59,130,246,.3)}.btn-ghost{background:rgba(26,30,38,.68);color:#cfd3dc;border-color:rgba(255,255,255,.06)}.btn-ghost:hover{background:#20242c;color:#f4f4f5;border-color:rgba(255,255,255,.105)}.btn-read{background:var(--soft-green);color:#d6fadd;border-color:rgba(34,197,94,.22)}.btn-read:hover{background:rgba(34,197,94,.15);border-color:rgba(34,197,94,.35)}.btn-dl{background:rgba(34,197,94,.1);color:#d6fadd;border-color:rgba(34,197,94,.22)}.btn-dl:hover{background:rgba(34,197,94,.15);border-color:rgba(34,197,94,.34)}.btn-del{background:rgba(239,68,68,.055);color:#f6b3b3;border-color:rgba(239,68,68,.18);font-size:12px}.btn-del:hover{background:rgba(239,68,68,.105);border-color:rgba(239,68,68,.34);color:#fecaca}
.lib-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(190px,1fr));gap:18px}.m-card{overflow:hidden;border:1px solid var(--line-soft);border-radius:16px;background:#111114;box-shadow:0 14px 44px rgba(0,0,0,.28);transition:.18s ease}.m-card:hover{transform:translateY(-3px);border-color:#3f3f46}.m-cover{position:relative;aspect-ratio:2/3;background:#18181b;overflow:hidden}.m-cover img{width:100%;height:100%;object-fit:cover;display:block;transition:transform .28s ease}.m-card:hover .m-cover img{transform:scale(1.025)}.m-cover::after{content:"";position:absolute;inset:55% 0 0;background:linear-gradient(to top,rgba(0,0,0,.86),transparent);pointer-events:none}.m-cover-ph{width:100%;height:100%;align-items:center;justify-content:center;color:#71717a}.m-cover-ph svg{width:66px;height:66px;stroke:currentColor;fill:none;stroke-width:1.5}.m-badges{position:absolute;top:10px;left:10px;right:10px;display:flex;gap:6px;flex-wrap:wrap;z-index:2}.m-badge{padding:5px 7px;border-radius:7px;background:rgba(9,9,11,.78);border:1px solid rgba(255,255,255,.12);backdrop-filter:blur(10px);color:#e4e4e7;font:800 9px/1 var(--mono);letter-spacing:.06em;text-transform:uppercase}.mb-cbz{color:#bbf7d0}.mb-opt{color:#d8b4fe}.m-overlay{position:absolute;left:10px;right:10px;bottom:10px;z-index:3}.m-overlay-btn{width:100%;display:flex;align-items:center;justify-content:center;gap:8px;padding:11px 14px;border:1px solid rgba(34,197,94,.24);border-radius:10px;background:rgba(18,46,35,.72);backdrop-filter:blur(10px);color:#dcfce7;font-weight:900;cursor:pointer;box-shadow:0 10px 30px rgba(0,0,0,.34),inset 0 1px 0 rgba(255,255,255,.055)}.m-overlay-btn:hover{background:rgba(21,64,45,.86);border-color:rgba(34,197,94,.38)}.m-info{padding:13px 13px 9px}.m-name{font-size:14px;font-weight:900;line-height:1.25;min-height:35px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.m-meta{margin-top:7px;color:#8d8d96;font:800 10px/1 var(--mono);text-transform:uppercase;letter-spacing:.06em}.m-actions{display:grid;gap:8px;padding:0 13px 13px}.m-main-actions{display:grid;gap:8px;min-width:0}.m-actions .btn{width:100%;padding:9px 11px;font-size:12px}.m-main-actions .btn{color:#dedee4}.m-main-actions .btn-dl{color:#d6fadd}.m-main-actions .btn-ghost{background:rgba(88,80,236,.075);border-color:rgba(129,140,248,.16);color:#dddfff}.m-main-actions .btn-ghost:hover{background:rgba(88,80,236,.12);border-color:rgba(129,140,248,.28)}.m-del-row{display:grid;grid-template-columns:1fr 1fr;gap:6px}.m-del-row .btn{height:34px;padding:0 9px;justify-content:center;line-height:1.2}.m-del-row .btn svg{width:15px;height:15px}.m-del-row .del-src{grid-column:1/-1;width:100%;color:#f2c6c6;background:rgba(239,68,68,.06);border-color:rgba(239,68,68,.2)}.m-del-row .del-src .del-label{position:static;width:auto;height:auto;overflow:visible;clip:auto;white-space:nowrap;font-size:11px}.m-del-row .del-opt{background:rgba(168,85,247,.07);border-color:rgba(168,85,247,.2);color:#e9d5ff}.m-del-row .del-cbz{background:rgba(59,130,246,.07);border-color:rgba(59,130,246,.2);color:#bfdbfe}.m-del-row .del-opt:hover{background:rgba(168,85,247,.12);border-color:rgba(168,85,247,.34)}.m-del-row .del-cbz:hover{background:rgba(59,130,246,.12);border-color:rgba(59,130,246,.34)}.m-del-row .del-src:hover{background:rgba(239,68,68,.11);border-color:rgba(239,68,68,.35)}.del-label,.del-small{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap}
...
.bot-nav{display:none;position:fixed;left:0;right:0;bottom:0;z-index:200;padding:8px 10px calc(8px + env(safe-area-inset-bottom));background:linear-gradient(to top,rgba(7,7,8,.98),rgba(7,7,8,.82),transparent)}.bot-nav-inner{height:58px;display:grid;grid-template-columns:repeat(4,1fr);gap:5px;padding:5px;border:1px solid var(--line-soft);border-radius:15px;background:#111114;box-shadow:0 10px 40px rgba(0,0,0,.42)}.bn{position:relative;border:0;background:transparent;color:var(--dim);border-radius:11px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;font-size:10px;font-weight:900;cursor:pointer}.bn::before{content:"";position:absolute;top:4px;left:28%;right:28%;height:2px;background:transparent}.bn:hover{background:rgba(26,30,38,.62);color:#d4d4d8}.bn.active{background:linear-gradient(180deg,rgba(59,130,246,.12),rgba(26,30,38,.72));color:#f4f4f5}.bn.active::before{background:#dbeafe}.bn svg{width:20px;height:20px;stroke:currentColor;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.bn-bdg{position:absolute;top:4px;right:20%;display:none;min-width:18px;height:18px;border-radius:999px;background:#3f3f46;color:#fff;font:900 9px/18px var(--mono)}#toast{position:fixed;right:16px;bottom:16px;z-index:600;max-width:320px;opacity:0;transform:translateY(8px);pointer-events:none;transition:.18s ease;padding:12px 14px;border:1px solid var(--line);border-radius:12px;background:#151519;box-shadow:var(--shadow);font:800 12px/1.4 var(--mono);color:#f4f4f5}#toast.show{opacity:1;transform:none}.empty{grid-column:1/-1;padding:52px 16px;border:1px dashed var(--line);border-radius:16px;background:#101013;color:var(--dim);font:800 13px/1.5 var(--mono);text-align:center}
